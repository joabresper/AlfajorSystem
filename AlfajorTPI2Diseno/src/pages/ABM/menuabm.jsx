...
const Menuabm = () => {
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative', background: '#E6D9B6' }}>
      ...
      {/* Sección Alta */}
      <div style={{ width: 147, height: 73, padding: 12, position: 'absolute', left: '30%', top: '50%', transform: 'translateY(-50%)', background: '#CF7C20', borderRadius: 8, overflow: 'hidden', border: '1px #2C2C2C solid', display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <div style={{ width: 253, height: 75, padding: 12, position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', background: '#CF7C20', borderRadius: 8, overflow: 'hidden', border: '1px #2C2C2C solid', display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      {/* Sección Baja */}
      <div style={{ width: 174, height: 75, padding: 12, position: 'absolute', left: '60%', top: '50%', transform: 'translateY(-50%)', background: '#CF7C20', borderRadius: 8, overflow: 'hidden', border: '1px #2C2C2C solid', display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      {/* Botón Cerrar sesión */}
      <div style={{ width: 414, height: 111, padding: 12, position: 'absolute', left: '50%', top: '70%', transform: 'translate(-50%, -50%)', background: '#CF7C20', borderRadius: 8, overflow: 'hidden', border: '1px #2C2C2C solid', justifyContent: 'center', alignItems: 'center', gap: 8, display: 'flex' }}>
        <div style={{ color: '#F5F5F5', fontSize: 48, fontFamily: 'Inter', fontWeight: '400', lineHeight: '57.60px', wordWrap: 'break-word' }}>Cerrar sesión</div>
      </div>
    </div>
  );
};
