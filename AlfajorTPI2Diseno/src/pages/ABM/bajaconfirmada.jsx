...
const BajaConfirmada = () => {
    return (
        <div style={{ width: 1920, height: 1080, position: 'relative', background: '#E6D9B6' }}>
          ...
          <div style={{ width: 342, height: 106, padding: 12, position: 'absolute', left: 789, top: 738, background: '#2C2C2C', borderRadius: 8, overflow: 'hidden', border: '1px #2C2C2C solid', justifyContent: 'center', alignItems: 'center', gap: 8, display: 'flex' }}>
